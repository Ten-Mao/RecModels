...
def initial_dataLoader(args):
    ...
    return (
        ...
        datasets["train"].get_adjacency_matrix()
    )

def initial_model(args, interaction_matrix, device):
    model = LightGCN(
        args.num_items,
        args.num_users,
        args.d_model,
...
def run():
    ...
    # initial dataLoader
    train_loader, valid_loader, test_loader, num_items, num_users, interaction_matix = initial_dataLoader(args)
